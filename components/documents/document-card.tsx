        ...
        <div className="flex shrink-0 items-center gap-1">
          {signedUrls?.has(doc.id) && (
            <Button
              variant="ghost"
              size="sm"
              className="size-8 rounded-lg p-0 opacity-0 transition-all group-hover:opacity-100"
              onClick={() => onPreview(doc)}
            >
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button
                variant="ghost"
                size="sm"
                className="size-8 rounded-lg p-0 text-muted-foreground opacity-0 transition-all hover:bg-red-50 hover:text-red-600 doc-delete-btn group-hover:opacity-100"
